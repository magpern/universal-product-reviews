...
**Recommended next implementation milestone:** **M11** planning (auto-approval), or a separately authorised SemVer/enablement GO for M10 external AI. M10 implementation is **closed** and accepted only after corrective PRs **#55–#57** (SemVer deferred; external AI still off by default): [`m10-external-ai-advisory-assessments-closure.md`](m10-external-ai-advisory-assessments-closure.md). M7 and M9 are closed at **`v0.8.0`**. M8 planning is closed.
