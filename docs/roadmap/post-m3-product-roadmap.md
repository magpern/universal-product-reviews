...
- **M12** — Sole contract **`auto_spam_held_technical`** (hold→spam CAS + parity + leased ledger + calibrated tuple + strict boundary). Freeze: [`m12-guarded-auto-spam.md`](m12-guarded-auto-spam.md). ADR: [`../decisions/ADR-0004-ai-moderation-boundary.md`](../decisions/ADR-0004-ai-moderation-boundary.md). **Calibration NO-GO / automatic action deferred:** [`m12-calibration-nogo.md`](m12-calibration-nogo.md). Closure: [`m12-guarded-auto-spam-closure.md`](m12-guarded-auto-spam-closure.md). Auto-approve permanently excluded. Demoted appendix: [`../future/ai-review-scoring.md`](../future/ai-review-scoring.md).
