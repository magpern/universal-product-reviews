...
- **M12** — Sole contract **`auto_spam_held_technical`**. Freeze: [`m12-guarded-auto-spam.md`](m12-guarded-auto-spam.md). Two-gate evidence: **Simulation GO** (synthetic → implementation + non-prod testing) / **Calibration GO** (real-world → production enablement may be considered). Posture: [`m12-calibration-nogo.md`](m12-calibration-nogo.md). Closure: [`m12-guarded-auto-spam-closure.md`](m12-guarded-auto-spam-closure.md). Kit: `scripts/calibration/evidence-kit/`. Auto-approve permanently excluded.
