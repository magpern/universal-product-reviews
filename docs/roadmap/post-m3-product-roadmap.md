...
- **M12** — Sole contract **`auto_spam_held_technical`**. Freeze: [`m12-guarded-auto-spam.md`](m12-guarded-auto-spam.md). **Calibration NO-GO / automatic action deferred:** [`m12-calibration-nogo.md`](m12-calibration-nogo.md). Closure: [`m12-guarded-auto-spam-closure.md`](m12-guarded-auto-spam-closure.md). Privacy-safe evidence kit (preparation only): `scripts/calibration/evidence-kit/`. Auto-approve permanently excluded. Demoted appendix: [`../future/ai-review-scoring.md`](../future/ai-review-scoring.md).
