...
Private WooCommerce plugin (`UPR`) for verified-purchase product reviews, line-item invitation lifecycle, moderation, retention, and host adapter integration.
...
| Document | Purpose |
|----------|---------|
| [`ARCHITECTURE.md`](ARCHITECTURE.md) | Authoritative frozen specification (Rev 6) |
...
Proprietary — private repository. See [`LICENSE.md`](LICENSE.md).
